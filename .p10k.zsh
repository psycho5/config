# Generated by Powerlevel10k configuration wizard on 2021-03-28 at 15:18 IST.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 32822.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# vertical separators, sharp heads, sharp tails, 2 lines, dotted, left frame,
...
() {
  ...
  typeset -g POWERLEVEL9K_ASDF_JAVA_FOREGROUND="black"
